...
Usage:
  python figure_01_v7.py --outputs-dir outputs
"""
...
def create_figure(outputs_dir: Path, output_path: Path):
    ...
    # ---- Colorbar ----
    print("\n[4/5] Adding colorbar...")
    # Place the colorbar lower to add clear separation from Panel E x-axis label.
    cax = fig.add_axes([0.30, 0.006, 0.40, 0.008])
    ...
    cbar.ax.text(0.0, 1.55, "Coupled", transform=cbar.ax.transAxes,
                 fontsize=FONT["tick"], ha="left", va="bottom",
                 color=COUPLED_GREEN, fontweight="bold")
    cbar.ax.text(1.0, 1.55, "Anti-aligned", transform=cbar.ax.transAxes,
                 fontsize=FONT["tick"], ha="right", va="bottom",
                 color=MID_YLGREEN, fontweight="bold")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="outputs/figures/figure_1.png")
